...
def creating_dataset(root):
    ...
    for category in tqdm(original_categorical_featurenames):
    ...
    prudential_data.to_csv("prudential_data_normalized.csv")
    ...
    with open("prudential_data_normalized.csv", encoding="utf-8") as csvfile:
